...
export const CATEGORY_KEYS = [
    'foods-drinks', 'shopping','entertainment', 'date', 'groceries', 'transport', 'school', 'fallback',
] as const
...
export const CATEGORIES: Category[] = [
  ...
  { //id: '3',
     name: 'Entertainment',  iconKey: 'entertainment' },
  { //id: '4',
     name: 'Date',           iconKey: 'date' },
  { //id: '5',
     name: 'Groceries',      iconKey: 'groceries' },
  { //id: '6',
     name: 'Transport',      iconKey: 'transport' },
  { //id: '7',
